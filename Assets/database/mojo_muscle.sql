-- =============================================
-- THE MOJO MUSCLE - Full Database Schema v2
-- Drop old DB and re-run this fresh in phpMyAdmin
-- =============================================
...
('MojoAdmin', 'admin@mojo.com', 'admin123', 'admin');

-- SAMPLE CLASSES
INSERT INTO gym_classes (class_name, instructor, schedule_day, start_time, end_time, max_slots) VALUES
('Power Lifting', 'Coach Mojo', 'Monday', '08:00:00', '09:00:00', 15),
('Cardio Blast', 'Coach Jojo', 'Wednesday', '10:00:00', '11:00:00', 20),
('Yoga & Stretch', 'Coach Buttercup', 'Friday', '07:00:00', '08:00:00', 12),
('HIIT Training', 'Coach Mojo', 'Tuesday', '06:00:00', '07:00:00', 18),
('Core Crusher', 'Coach Jojo', 'Thursday', '09:00:00', '10:00:00', 15),
('Weekend Warrior', 'Coach Mojo', 'Saturday', '09:00:00', '10:30:00', 25);
